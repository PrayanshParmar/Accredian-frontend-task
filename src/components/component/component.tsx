...
* @see https://v0.dev/t/ZMJ8SvpZsZf
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-muted-foreground">sarahmiller@example.com</div>
                        </div>
                      </div>
                    </TableCell>
          ...
          <Card className="col-span-2 lg:col-span-3 xl:col-span-4">
            <CardHeader>
              ...
              <CardDescription>Detailed performance metrics for your referral program.</CardDescription>
            </CardHeader>
            <CardContent>
